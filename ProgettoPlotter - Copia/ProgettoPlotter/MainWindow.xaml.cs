...
namespace ProgettoPlotter
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void ImageDeleteFile_MouseDown(object sender, MouseButtonEventArgs e)
        {
            int ris = manager.DeleteFile();     /* Call manager function */
            if (ris == 1) this.Close();         /* Close this window */
        }
        ...
        /*
         ...
         1 - Finire le funzioni del menù dal click 4 in poi
         2 - Finire il protocollo di stampa
